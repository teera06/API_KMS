...
void Stage3_Map::SetMapImage(std::string_view _MapImageName)
{
...
void Stage3_Map::SetColMapImage(std::string_view _MapImageName)
{
...
void Stage3_Map::Tick(float _DeltaTime)
{
